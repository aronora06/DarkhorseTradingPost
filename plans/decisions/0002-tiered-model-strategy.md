...
**Hard pass:** China-hosted models (DeepSeek, Kimi, Qwen) and self-hosted models. Rationale documented in `../riskMitigation.md` §2.3 and signed off in `../../suggestedNextSteps.md` §2.
